...
namespace aggregators {
    namespace bs {
        ...
        void episode::file::rename_files(series& _series, string directory_name, string pattern_str) {
            ...
            vector<string> changes = aggregators::bs::rename_files(_series, directory_name, pattern_str, false);
            if (changes.size() == 0)
                ...
                aggregators::bs::rename_files(_series, directory_name, pattern_str, true);
            }
        }
